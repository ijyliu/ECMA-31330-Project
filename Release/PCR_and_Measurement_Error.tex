...
\begin{document}
    ...
    \section*{Conclusion}
        ...
        Given more time, we would have liked to explore an empirical application somewhat closer to the ideal setting for PCR; a case with many more covariates and many fewer observations, with variables on different scalings. In such a situation it might also be appropriate to make use of more principal components. Additionally, we might have liked to make use of optimization over a wider range of parameter values to find more scenarios where PCR best satisfies a suitable objective function. Nevertheless, this paper has shown that there are cases where PCR may be a useful solution to measurement error.
