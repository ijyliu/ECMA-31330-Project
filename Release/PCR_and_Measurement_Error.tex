...
\begin{table}[!htbp] \centering
  ...
  \input{../Output/Tables/covariance_coefs_no_exp.tex}
    ...
    \input{../Output/Tables/covariance_apes_no_exp.tex} \\
    \hline \\[-1.8ex]
...
\begin{table}[!htbp] \centering
  ...
  & \multicolumn{5}{c}{\textit{Mean Absolute Percentage Error}} \\
    \input{../Output/Tables/covariance_apes_exp.tex} \\
    \hline \\[-1.8ex]
    Simulations & 1,000 & 1,000 & 1,000 & 1,000 & 1,000\\
  \hline
  \hline \\[-1.8ex]
...
\clearpage
    ...
    \begin{table}[!htbp] \centering
      ...
      \input{../Output/Tables/beta1_apes_no_exp.tex} \\
      \hline \\[-1.8ex]
      ...
      & \multicolumn{3}{c}{\textit{Mean Absolute Percentage Error}} \\
       \input{../Output/Tables/beta2_apes_no_exp.tex}  \\ 
      \hline \\[-1.8ex]
      Simulations & 1,000 & 1,000 & 1,000 & \\
      \hline
      \hline \\[-1.8ex]
      ...
      & \multicolumn{3}{c}{\textit{Mean Absolute Percentage Error}} \\
      \input{../Output/Tables/p_apes_no_exp.tex} \\
      \hline \\[-1.8ex]
      Simulations & 1,000 & 1,000 & 1,000  \\
      \hline
      \hline \\[-1.8ex]
      ...
      & \multicolumn{3}{c}{\textit{Mean Absolute Percentage Error}} \\
      \input{../Output/Tables/beta1_apes_exp.tex}\\
      \hline \\[-1.8ex]
       Simulations & 1,000 & 1,000 & 1,000 &\\
      \hline
      \hline \\[-1.8ex]
      ...
      \begin{table}[!htbp] \centering
        ...
        & \multicolumn{3}{c}{\textit{Mean Absolute Percentage Error}} \\
        \input{../Output/Tables/beta2_apes_exp.tex} \\
        \hline \\[-1.8ex]
        Simulations & 1,000 & 1,000 & 1,000 &\\
        \hline
        \hline \\[-1.8ex]
        ...
        \begin{table}[!htbp] \centering
          ...
          & \multicolumn{3}{c}{\textit{Mean Absolute Percentage Error}} \\
          \input{../Output/Tables/p_apes_exp.tex} \\
