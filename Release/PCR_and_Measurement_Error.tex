...
\begin{document}
    ...
    \section*{Properties of the Estimator: Monte Carlo Simulations}
        ...
        \input{../Output/Tables/parallel_covariance_coefs_me_cov_0.tex}
            & \multicolumn{5}{c}{\textit{Mean Absolute Percentage Error}} \\
            \input{../Output/Tables/parallel_covariance_apes_me_cov_0.tex} \\[-4mm]
            \hline \\[-1.8ex]
        ...
        We also explore how our results differ under a different framework of measurement error. For the following regressions (and those in the simulation appendix) we relax our assumption that the measurement errors are uncorrelated with one another. This means that we replace the diagonal matrix $\Sigma$ from before with a matrix where the diagonal values continue to be $1$ but we replace all other values in the matrix (that used to be $0$) with $0.5$. Since our instrumental variables technique is typically promoted for use with classical measurement error, we wanted to see how these relative methods changed when that assumption is relaxed. Table \ref{sim_rho_5_exp} shows the results of our five techniques in this new context.
        ...
        \hline \\[-1.8ex]
        & \multicolumn{5}{c}{\textit{Coefficient on Main Variable}} \\
        \input{../Output/Tables/parallel_covariance_coefs_me_cov_0.5.tex}
        & \multicolumn{5}{c}{\textit{Mean Absolute Percentage Error}} \\
            \input{../Output/Tables/parallel_covariance_apes_me_cov_0.5.tex} \\[-4mm]
            \hline \\[-1.8ex]
            Simulations & 1,000 & 1,000 & 1,000 & 1,000 & 1,000\\
        \hline
        \hline \\[-1.8ex]
...
\clearpage
    ...
    \begin{table}[!htbp] \centering
        \caption{Average Coefficients for Values of $\beta_1$ (Uncorrelated Measurement Errors) \label{sim_beta1_5_noexp}}
        \scalebox{0.75}{
      ...
      \input{../Output/Tables/parallel_beta1_coefs_me_cov_0.tex}
      & \multicolumn{3}{c}{\textit{Mean Absolute Percentage Error}} \\
      \input{../Output/Tables/parallel_beta1_apes_me_cov_0.tex} \\[-4mm]
      \hline \\[-1.8ex]
      ...
      \begin{table}[!htbp] \centering
        \caption{Average Coefficients for Values of $\beta_2$ (Uncorrelated Measurement Errors) \label{sim_beta2_5_noexp}}
        \scalebox{0.75}{
          \begin{tabular}{@{\extracolsep{5pt}}lcccc}
      \\[-1.8ex]\hline
      \hline \\[-1.8ex]
      & \multicolumn{3}{c}{\textit{True $\beta_2$}} \
      \cr \
      \\[-1.8ex] & 0.1 & 1 & 10\\
      \hline \\[-1.8ex]
      & \multicolumn{3}{c}{\textit{Coefficient on Main Variable}} \\
        \input{../Output/Tables/parallel_beta2_coefs_me_cov_0.tex}
      & \multicolumn{3}{c}{\textit{Mean Absolute Percentage Error}} \\
       \input{../Output/Tables/parallel_beta2_apes_me_cov_0.tex}  \\[-4mm]
      \hline \\[-1.8ex]
      Simulations & 1,000 & 1,000 & 1,000 \\
      \hline
      \hline \\[-1.8ex]
      ...
      \begin{table}[!htbp] \centering
        \caption{Average Coefficients for Values of $p$ (Uncorrelated Measurement Errors) \label{sim_p_5_noexp}}
        \scalebox{0.75}{
          \begin{tabular}{@{\extracolsep{5pt}}lcccc}
      \\[-1.8ex]\hline
      \hline \\[-1.8ex]
      ...
      \hline \\[-1.8ex]
      & \multicolumn{3}{c}{\textit{Coefficient on Main Variable}} \\
      \input{../Output/Tables/parallel_p_coefs_me_cov_0.tex}
      & \multicolumn{3}{c}{\textit{Mean Absolute Percentage Error}} \\
      \input{../Output/Tables/parallel_p_apes_me_cov_0.tex} \\[-4mm]
      \hline \\[-1.8ex]
      Simulations & 1,000 & 1,000 & 1,000  \\
      \hline
      \hline \\[-1.8ex]
      ...
      \begin{table}[!htbp] \centering
        \caption{Average Coefficients for Values of $\beta_1$ (Correlated Measurement Errors)\label{sim_beta1_5_exp}}
        \scalebox{0.75}{
        \begin{tabular}{@{\extracolsep{5pt}}lcccc}
      \\[-1.8ex]\hline
      \hline \\[-1.8ex]
      ...
      \hline \\[-1.8ex]
      & \multicolumn{3}{c}{\textit{Coefficient on Main Variable}} \\
      \input{../Output/Tables/parallel_beta1_coefs_me_cov_0.5.tex}
      & \multicolumn{3}{c}{\textit{Mean Absolute Percentage Error}} \\
      \input{../Output/Tables/parallel_beta1_apes_me_cov_0.5.tex} \\[-4mm]
      \hline \\[-1.8ex]
       Simulations & 1,000 & 1,000 & 1,000 \\
      \hline
      \hline \\[-1.8ex]
      ...
      \begin{table}[!htbp] \centering
        \caption{Average Coefficients for Values of $\beta_2$ (Correlated Measurement Errors) \label{sim_beta2_5_exp}}
        \scalebox{0.75}{
            \begin{tabular}{@{\extracolsep{5pt}}lcccc}
        \\[-1.8ex]\hline
        \hline \\[-1.8ex]
        ...
        \hline \\[-1.8ex]
        & \multicolumn{3}{c}{\textit{Coefficient on Main Variable}} \\
        \input{../Output/Tables/parallel_beta2_coefs_me_cov_0.5.tex}
        & \multicolumn{3}{c}{\textit{Mean Absolute Percentage Error}} \\
        \input{../Output/Tables/parallel_beta2_apes_me_cov_0.5.tex} \\[-4mm]
        \hline \\[-1.8ex]
        Simulations & 1,000 & 1,000 & 1,000 \\
        \hline
        \hline \\[-1.8ex]
        ...
        \begin{table}[!htbp] \centering
            \caption{Average Coefficients for Values of $p$ (Correlated Measurement Errors) \label{sim_p_5_exp}}
            \scalebox{0.75}{
          ...
          \hline \\[-1.8ex]
          & \multicolumn{3}{c}{\textit{Coefficient on Main Variable}} \\
          \input{../Output/Tables/parallel_p_coefs_me_cov_0.5.tex}
          & \multicolumn{3}{c}{\textit{Mean Absolute Percentage Error}} \\
          \input{../Output/Tables/parallel_p_apes_me_cov_0.5.tex} \\[-4mm]
