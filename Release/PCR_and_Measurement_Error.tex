...
\begin{document}
    ...
    \subsection*{Data Generating Process}
        ...
        To see the implications of the of this measurement error in the covariates, consider a simple case where the DGP depends only on the variable of interest and a covariate such that:
