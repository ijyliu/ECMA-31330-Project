...
\begin{document}
    ...
    \section*{Literature}
        ...
        Nagasawa 2020 
        %https://warwick.ac.uk/fac/soc/economics/staff/knagasawa/PartialEffects.pdf
...
\\
talk about the range of ps and how we didn't do higher values because of its plausibility
        \\
    ...
    \section*{Application: Government Share of Healthcare Spending and Life Expectancy}
        ...
        econ and life expectancy
        Ling et al Malaysia- economic growth increases life expectancy
        Acemoglu -reverse item, life expectancy leads to less growth... or no relation

        econ and government share of health expenditure
        %https://www.sciencedirect.com/science/article/pii/S0161893810000463
        Wu 2010- positive association between government spending and GDP
        spending helps, and low income countries have are dragged down by inefficient governments and inferior institutions

        %https://www.sciencedirect.com/science/article/pii/S0313592616300583?casa_token=Y4zMvBPlO8YAAAAA:P8Q7ScdxnW69LVlwM1-9epgEca7UYSf-QR1CFXTVx42aWb8Q04R2gI7b8wwr96A6dNQs2XFPprI
        Linden and Ray focus on the relationship between life expectancy at birth and public and private health expenditures for 34 OECD countries from 1970-2012.
        Topic studied in 'relatively few papers'
        public and private health spending are both important, and associated

        Novignon 2012
        both public and private spending has impacts in sub saharan africa but public spending had higher impact

        Fillmer 1999
        public spending not very effective in developing countries

        Cremieux 2005
        Canadian provinces 1975-1998 focus on drugs spending
        Private drug spending has a higher positive impact than public spending on life expectancy

        Lichtenberg 2000
        USA dynamic models from 1960-1997
        public and private expenditures, GDP, and drug approvals
        Positive effects for public expenditure, but not for private effects, particularly when lagged GDP is added to the model

        Or 2000
        %http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.411.6359&rep=rep1&type=pdf
        Predict premature death in 21 OECD countries from 1970-1992
        total HE and public share, along with pub health and environmental factors and GDP
        Most closely related to our paper, likely.
        Larger share of public spending is associated with lower rates of premature mortality for both males and females.
        GDP also associated with less premature mortality
        Many, many variables and fixed effects - like 30 ish but only 483 observations.
